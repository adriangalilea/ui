    ...
    <Lightbox>
      <div className="space-y-12">
        ...
        <p className="max-w-prose text-foreground/60 text-sm">
          Click any face with a <code className="font-mono text-xs">full</code>{" "}
          to open the portrait: the avatar is a lightbox trigger, so a face that
          invites a closer look can be looked at closer. Every one is positioned
          on its subject from the sidecar&apos;s{" "}
          <code className="font-mono text-xs">focus</code> and ringed in its own
          average colour.
        </p>
      </div>
    </Lightbox>
